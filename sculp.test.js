...
describe('The SCULP Parser', () => {
  ...
  it('should properly parse message constraints', () => {
    const result = parser.parse('when {usr:"frank", txt:*."?"} do post("Hi Frank! I will answer your question asap.")');
    expect(result.toString()).toBe('when { usr: "frank", txt: * . "?" } do post("Hi Frank! I will answer your question asap.")');
  });
